...
* [x] **Task 1.1: Refactor `MonsterAffixComponent`**
...
* [x] **Task 2.1: Update `MonsterAffixSystem::Update`**
...
* [x] **Task 2.2: Update Process Signatures**
...
* [x] **Task 3.1: Update Integration Test**
