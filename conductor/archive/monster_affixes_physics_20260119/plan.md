...
- [x] **Counter-Play Tuning**: ensure walls don't trap player permanently (destructible or timed).
- [x] **Physics Stability**: Verify `Vortex` doesn't pull players into walls/out of bounds.
