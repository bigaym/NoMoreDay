...
| 阶段 | 名称 | 核心产出 | 状态 |
|------|------|----------|------|
| **Phase 1** | 数据层 | 组件定义, DTO, 序列化逻辑 | ⬜ 未开始 |
| **Phase 2** | 系统逻辑层 | StashSystem 核心 API | ⬜ 未开始 |
| **Phase 3** | 持久化集成 | SaveManager 扩展 | ⬜ 未开始 |
| **Phase 4** | UI 层 | UIStash 界面渲染与交互 | ⬜ 未开始 |
| **Phase 5** | 城镇集成 | 仓库实体生成与交互 | ⬜ 未开始 |
| **Phase 6** | 测试与打磨 | 单元测试, 集成测试, Bug 修复 | ⬜ 未开始 |
