...
- [x] **Task 1.1: Restore Topology Data**
...
- [x] **Task 1.2: Fix Vow Attribute Leak**
...
- [x] **Task 1.3: Clean Hardcoded Paths**
...
- [x] **Task 2.1: Implement Connection Rendering**
...
- [x] **Task 2.2: Fix Camera & Background**
