...
- **Universal Origin Astrolabe:** A unified six-sector passive system centered on a black hole. Features a **deterministic constellation-based layout**, profession affinity unlocking, and a strictly enforced **"Vow" mechanic** for deep specialization.
