...
- **Concentric Astrolabe System:** A data-driven passive talent tree with a concentric layout, allowing for deep character specialization through Minor, Major, and Keystone nodes. Features an interactive, zoomable UI overlay with dynamic connection visuals, planning mode, and activation logic. Includes class-specific keystones like "Sword Heart" for Blade Ascendants.- **Procedural Map Generation:** A dynamic dungeon system ensuring that no two runs feel the same, promoting infinite replayability.
