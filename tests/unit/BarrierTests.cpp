...
TEST_CASE("[Unit] HybridBarrier - Stats Calculation") {
  ...
  mods.modifiers.push_back({.value = 500.0f,
                            .type = NoMoreDay::StatType::MaxBarrier,
                            .mode = NoMoreDay::ModifierMode::Flat});
  mods.modifiers.push_back({.value = 25.0f,
                            .type = NoMoreDay::StatType::BarrierRegen,
                            .mode = NoMoreDay::ModifierMode::Flat});
  mods.modifiers.push_back(
      {.value = -0.5f,
       .type = NoMoreDay::StatType::BarrierDelay,
       .mode = NoMoreDay::ModifierMode::Flat}); // Base 2.0 -> 1.5
  mods.modifiers.push_back(
      {.value = 50.0f,
       .type = NoMoreDay::StatType::BarrierDecay,
       .mode =
           NoMoreDay::ModifierMode::PercentAdd}); // Base 20% + 50% = 30% (0.3)
