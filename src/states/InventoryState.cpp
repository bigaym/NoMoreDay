...
#include "../systems/UISystem.hpp" // For State access and Facade
#include "../systems/UIInventory.hpp"
#include "../core/StateManager.hpp"
#include "../core/UIRenderer.hpp" // Direct renderer access
...
namespace NoMoreDay {
    ...
    bool InventoryState::OnUpdate(float dt) {
        ...
        return false; // Block updates for states below (Gameplay paused)
    }
