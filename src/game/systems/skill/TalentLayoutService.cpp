...
void TalentLayoutService::computeNodePositions(TalentGraph& graph) {
    // 1. Compute positions for Profession Stars (Inner Ring)
    ...
    // 2. Group nodes by (Profession, Tier)
    // Key: {ProfessionID, Tier} -> List of Nodes*
...
float TalentLayoutService::getOrbitRadius(uint8_t tier) {
    ...
    switch (tier) {
        case 1: return ORBIT_R2;
        case 2: return ORBIT_R3;
        case 3: return ORBIT_R4;
        default: return ORBIT_R2;
    }
}
