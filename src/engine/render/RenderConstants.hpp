...
enum class TextureUnit : uint32_t {
  ...
  TEX_MATERIAL_ALBEDO_ARRAY = 4,
  TEX_MATERIAL_NORMAL_ARRAY = 5,
  TEX_MATERIAL_MASK_ARRAY = 6,
  TEX_MATERIAL_DETAIL_ARRAY = 7,
  TEX_MATERIAL_ROUGHNESS_ARRAY = TEX_MATERIAL_MASK_ARRAY,
};
